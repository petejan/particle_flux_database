# to parse Honjo global data compilation datafiles to pangaea_sqlite database
...
filename = r'C:\Users\wyn028\OneDrive - CSIRO\Manuscripts\Particle_flux_database\Honjo_global_datacompilation_JGOFS\sed_traps_ts_flux.csv'
metadata_filename = r'C:\Users\wyn028\OneDrive - CSIRO\Manuscripts\Particle_flux_database\Honjo_global_datacompilation_JGOFS\README.txt'
unit_metadata_fn = r'C:\Users\wyn028\OneDrive - CSIRO\Manuscripts\Particle_flux_database\Honjo_global_datacompilation_JGOFS\sed_traps_ts_flux_units.csv'
# read the csv file
data = pd.read_csv(filename)
# convert date to the right format
data['date_start'] = pd.to_datetime(data.date_start, format='%Y%m%d')
data['date_start'].dt.strftime('%Y/%m/%d')
mean_depth = data['Trap_Depth'].mean()
