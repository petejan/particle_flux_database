# to parse SEANOE float POC flux estimate datafiles to pangaea_sqlite database
...
filename = r'C:\Users\wyn028\OneDrive - CSIRO\Manuscripts\Particle_flux_database\SEANOE data base\Argo float POC estimate database\Flux_1000m_102097_CWE.csv'
metadata_filename = r'C:\Users\wyn028\OneDrive - CSIRO\Manuscripts\Particle_flux_database\SEANOE data base\Argo float POC estimate database\README.txt'
unit_metadata_fn = r'C:\Users\wyn028\OneDrive - CSIRO\Manuscripts\Particle_flux_database\SEANOE data base\Argo float POC estimate database\Flux_1000m_102097_units.csv'
# read the csv file
